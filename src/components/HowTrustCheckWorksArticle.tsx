...
interface HowTrustCheckWorksArticleProps {
  showBackLink?: boolean;
  titleId?: string;
}

export default function HowTrustCheckWorksArticle({
  showBackLink = true,
  titleId
}: HowTrustCheckWorksArticleProps) {
  return (
    <article className="how-card">
      <header>
        ...
        <p>
          ...
          AI detector. It does not determine whether something is true or false.
          Instead, it helps users see what supports trust, what weakens trust,
          and what may need a closer look.
        </p>
      </header>
      ...
      <section>
        ...
        <p>
          ...
          Each category is scored on a scale from 1 to 5, then combined into an
          overall Trust Score from 0 to 100.
        </p>
        <p>
          TrustCheck looks not only at whether uncertainty language appears, but
          also how it is used. Cautious wording can reflect genuine
          intellectual honesty, but it can also be used to avoid specificity or
          accountability. Selective or uneven hedging may be treated as a
          credibility weakness when it is not supported by clear sourcing,
          evidence, or context.
        </p>
        <ul>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            ...
            <br />
            Does the content clearly separate observable facts from conclusions,
      ...
      <section>
        ...
        <p className="how-note-spaced">
          ...
          appears to support, and how much caution or verification may still be
          needed.
        </p>
      </section>
      ...
      <section>
        ...
        <p>Because of this:</p>
        <ul>
          <li>a claim may be true but weakly supported in the provided text</li>
          <li>
            a claim may be misleading in reality while still being presented
            with relatively strong credibility signals
          </li>
          <li>
        ...
        <p className="how-note-spaced">
          TrustCheck is designed to support evaluation of credibility signals,
          not replace fact-checking or real-world verification.
        </p>
      </section>
